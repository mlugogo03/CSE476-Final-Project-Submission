...
### 4. Self-Verification
After generating an initial answer it asks a strict grader model if the answer should be accepted. 
...
2. Ensure Python 3 and the requests package are installed.
